...
/**
 * help_alias - shows information on shellby builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_exit - shows information on shellby builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - shows info on shellby builtin command 'help'.
 */
void help_help(void)
{
